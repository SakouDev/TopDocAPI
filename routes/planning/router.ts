...
import { handlerPlanning } from './handler'
 ...
 *          description: Get the list of all planning.
 */
planningRouter.get('/', handlerPlanning.getAllPlanning)
 ...
 */
planningRouter.post('/', handlerPlanning.createPlanning)
